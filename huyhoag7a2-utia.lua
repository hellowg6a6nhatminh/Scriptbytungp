...
shared.LoaderTitle = "Đăng Ký Kênh Huy Hoàng 7a2 ";
...
v23.Draggable = true;
v23.Image = "http://www.roblox.com/asset/?id=128325456253565";
v24.Parent = v23;
...
if Sea3 then
    ...
    function UpdateKitsune()
        if game:GetService("Workspace").Map:FindFirstChild("KitsuneIsland") then
            v499:SetDesc("Đảo Cáo : đã xuất hiện");
        else
            v499:SetDesc("Đảo Cáo : Chưa Xuât trình");
        end
    end
    spawn(function()
        pcall(function()
...
local v68 = v16.Sea:AddToggle("Togglelockmoon", {
    Title = "Nhìn Trăng Và Bật v3 Tộc",
    Description = "",
    Default = false
});
