...
Button.Image = "rbxassetid://92261967377043"
...
Tabs.Info:AddParagraph({
    Title="Update",
    Content="Hỗ Trợ Full Client PC"
})
Tabs.Info:AddParagraph({
    Title="Hỗ Trợ Full Client Điện Thoại",
    Content=""
})
Tabs.Info:AddParagraph({
    Title="Ko còn gì nữa",
...
_G.FastAttackVxeze_Mode="Rubu Attack"
spawn(function()
    while wait() do
...
local DropdownSelectWeapon = Tabs.Main:AddDropdown("DropdownSelectWeapon", {
    Title = "Cận Chiến",
    Description = "Chọn Vũ Khi Sử Dụng",
...
task.spawn(function()
    ...
    local ToggleLevel = Tabs.Main:AddToggle("ToggleLevel", {
        Title="Cày Cấp",
        Description="Cày Từ Lv 1 Đến Lv Max",
        Default=false })
    ...
    function getHighestPoint()
        ...
        for _, v in pairs(game:GetService("Workspace").Map.MysticIsland:GetDescendants()) do
            if v:IsA("MeshPart") then
                if v.MeshId=="rbxassetid://92261967377043" then
                    return v
                end
            end
        end
